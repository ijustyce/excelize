...
// StreamRead 魔改的官方的 OpenFile，解决官方调用 io.ReadAll 的问题
// 官方的 OpenFile 调用了 OpenReader，而 OpenReader 调用了 io.ReadAll
// 详情请看文档：[解决官方 OpenReader 调用 io.ReadAll](https://shopline.yuque.com/staff-gznel5/cirz85/ylmlxc73nwvi16fe?singleDoc)
